...
.method public a()Ljava/lang/String;
    ...
    const-string/jumbo p0, "ws://speech-staging.ai.xiaomi.com/speech/v1.0/longaccess"
    ...
    const-string/jumbo p0, "wss://speech-preview.ai.xiaomi.com/speech/v1.0/longaccess"
    ...
    const-string/jumbo p0, "wss://preview4test-access-speech.ai.xiaomi.com/speech/v1.0/longaccess"
    ...
    invoke-virtual {p0, v1, v0}, Lcom/xiaomi/ai/core/AivsConfig;->getBoolean(Ljava/lang/String;Z)Z

    move-result p0

    if-eqz p0, :cond_4

    const-string/jumbo p0, "wss://tw.speech.ai.xiaomi.com/speech/v1.0/longaccess"

    return-object p0

    :cond_4
    const-string/jumbo p0, "wss://speech.ai.xiaomi.com/speech/v1.0/longaccess"
...
.method public b()Ljava/lang/String;
    ...
    const-string/jumbo p0, "ws://staging.access.speech.ai.xiaomi.com/speech/v1.0/longaccess"
    ...
    const-string/jumbo p0, "ws://preview.access.speech.ai.xiaomi.com/speech/v1.0/longaccess"
    ...
    const-string/jumbo p0, "ws://preview4test.access.speech.ai.xiaomi.com/speech/v1.0/longaccess"
    ...
    const-string/jumbo p0, "ws://tw.access.speech.ai.xiaomi.com/speech/v1.0/longaccess"

    return-object p0

    :cond_4
    const-string/jumbo p0, "ws://access.speech.ai.xiaomi.com/speech/v1.0/longaccess"
...
.method public c()Ljava/lang/String;
    ...
    const-string/jumbo p0, "xmd://staging.accessxmd.speech.ai.xiaomi.com/speech/v1.0/longaccess"
    ...
    const-string/jumbo p0, "xmd://preview.accessxmd.speech.ai.xiaomi.com/speech/v1.0/longaccess"
    ...
    const-string/jumbo p0, "xmd://preview4test.accessxmd.speech.ai.xiaomi.com/speech/v1.0/longaccess"
    ...
    const-string/jumbo p0, "xmd://tw.accessxmd.speech.ai.xiaomi.com/speech/v1.0/longaccess"

    return-object p0

    :cond_4
    const-string/jumbo p0, "xmd://accessxmd.speech.ai.xiaomi.com/speech/v1.0/longaccess"
