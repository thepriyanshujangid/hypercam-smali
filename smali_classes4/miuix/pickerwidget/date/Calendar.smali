...
.method private computeChineseEraNames(J)V
    ...
    invoke-static {v0, v1, v2}, Lmiuix/pickerwidget/date/Calendar;->mod(JI)I
...
.method private computeDate(JJ)V
    ...
    .line 12
    invoke-static {p1, p2, p4}, Lmiuix/pickerwidget/date/Calendar;->mod(JI)I
...
.method private computeDateTime()J
    ...
    :cond_8
    :goto_4
    invoke-direct {v0, v4, v5, v8, v9}, Lmiuix/pickerwidget/date/Calendar;->computeDate(JJ)V
